...
public class metro  {
        public metro() throws IOException {
            lines();
        }
        ...
        private void lines() throws IOException {
            ...
            lines=lines+"\n]";
            stations=stations+"\n}";
            FileWriter writer = new FileWriter(("C:\\Users\\User\\IdeaProjects\\ex25_26\\src\\main\\java\\file.json"));
            writer.write("{\n");
        ...
        public void read() throws IOException {
            ...
            JsonReader reader = new JsonReader(new FileReader("C:\\Users\\User\\IdeaProjects\\ex25_26\\src\\main\\java\\file.json"));
